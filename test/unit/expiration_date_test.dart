...
void main() {
  test("更新手続き時は、当日から数えて3回目の誕生日が期限", () {
    withClock(Clock.fixed(DateTime(2020, 1, 1)), () {
      expect(
        calculateExpirationDate(ProcedureType.update, DateTime(2000, 2, 1), null, null)?.$1,
  ...
  test("新規・変更手続き時は、当日から数えて2回目の誕生日が期限", () {
    withClock(Clock.fixed(DateTime(2020, 1, 1)), () {
      expect(
        calculateExpirationDate(ProcedureType.newAcquisition, DateTime(2000, 2, 1), null, null)?.$1,
  ...
  test("更新手続き時、手続き日が誕生日の1ヶ月前である場合、手続き日から数えて3回目の誕生日が期限", () {
    withClock(Clock.fixed(DateTime(2024, 5, 1)), () {
      expect(
        calculateExpirationDate(ProcedureType.update, DateTime(2000, 6, 1), null, null)?.$1,
  ...
  test("どちらか片方の手帳を所持していて期限がある場合、本来の期限と比較して早い方が期限", () {
    ...
    withClock(Clock.fixed(DateTime(2019, 1, 1)), () {
      expect(
        calculateExpirationDate(ProcedureType.newAcquisition, DateTime(2000, 2, 1), physicalExpire, null)?.$1,
  ...
  test("両方の手帳の期限がある場合、2つの手帳の期限で遅い方と、本来の期限と比較して早い方が期限", () {
    ...
    withClock(Clock.fixed(DateTime(2020, 1, 1)), () {
      expect(
        calculateExpirationDate(ProcedureType.newAcquisition, DateTime(2000, 2, 1), physicalExpire, rehabilitationExpire)?.$1,
  ...
  test("誕生日が閏日の場合の処理", () {
    withClock(Clock.fixed(DateTime(2024, 3, 1)), () {
      expect(
        calculateExpirationDate(ProcedureType.newAcquisition, DateTime(2004, 2, 29), null, null)?.$1,
